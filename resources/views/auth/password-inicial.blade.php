...
<head>
    ...
    <title>Definir contraseña - Todotex</title>
    @vite(['resources/css/app.css', 'resources/js/app.js'])
</head>
<body class="bg-gray-50 min-h-screen flex items-center justify-center py-12 px-4">
    <div class="w-full max-w-md">
        <div class="text-center mb-8">
            <h1 class="text-2xl font-bold text-gray-900">Definir contraseña inicial</h1>
            <p class="text-sm text-gray-500 mt-1">{{ $nombre }} — Es tu primer acceso a la Zona Privada</p>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow p-8">
            ...
            <form method="POST" action="{{ route('cliente.password.inicial.store') }}" class="space-y-5">
                @csrf
            ...
            <p class="text-center text-xs text-gray-400 mt-6">
                ¿Tenés problemas? Contactá a <x-soporte-ventas/>
            </p>
        </div>
    </div>
</body>
