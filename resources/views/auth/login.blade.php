...
<head>
    ...
    <style>
        ...
        .gradient-bg {
            background: linear-gradient(135deg, #23378C 0%, #018637 100%);
        }
    </style>
</head>
<body class="min-h-screen bg-gray-50 flex items-center justify-center p-4">
    ...
    <div class="w-full max-w-md">
        ...
        <div class="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden animate-fadeInUp">
            ...
            <div class="gradient-bg px-8 py-8 text-center">
                @if($contactData && $contactData->icono_2)
                    <a wire:navigate href="{{ url('/') }}" class="inline-block mb-4">
                        <img src="{{ Storage::url($contactData->icono_2) }}" 
                             class="h-25 w-auto object-contain mx-auto"
                             alt="Logo">
                    </a>
                @endif
            </div>
            ...
            <div class="px-8 py-8">
                @if($errors->any())
                    <div class="mb-6 bg-blue-50 border-l-4 border-[#23378C] text-blue-900 px-4 py-3 rounded-r-lg flex items-start gap-3">
                        ...
                        <div class="relative">
                            ...
                            <input 
                                ...
                                class="block w-full pl-10 pr-3 py-3 border border-gray-300 rounded-lg text-gray-900 placeholder-gray-400
                                       focus:outline-none focus:ring-2 focus:ring-[#23378C] focus:border-transparent transition-all"
                    ...
                    <div class="flex items-center justify-between">
                        <label class="flex items-center gap-2 cursor-pointer group">
                            <input 
                                ...
                                name="remember"
                                id="remember"
                                class="w-4 h-4 border-gray-300 rounded text-[#23378C] focus:ring-[#23378C] cursor-pointer"
                            >
            ...
            <div class="px-8 py-6 bg-gray-50 border-t border-gray-100">
                <a wire:navigate href="{{ url('/') }}" 
                   class="flex items-center justify-center gap-2 text-sm text-gray-600 hover:text-[#23378C] transition-colors group">
        ...
        <div class="mt-6 text-center">
            <p class="text-sm text-gray-500">
                © {{ date('Y') }} Todotex. Todos los derechos reservados.
            </p>
        </div>
    </div>
