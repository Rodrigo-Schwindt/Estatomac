...
<div class="mx-auto space-y-8 animate-fadeIn">
    ...
    <form action="{{ route('categorias-padre.store') }}" method="POST" class="bg-white border border-slate-200 rounded-md shadow-sm p-8 space-y-6">
        @csrf
        
        <div class="space-y-6">
            <div class="flex items-center justify-between">
                <h2 class="text-2xl font-semibold text-slate-900">Crear Categoría Padre</h2>
