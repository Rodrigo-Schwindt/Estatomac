    ...
    <div class="overflow-x-auto border border-slate-200 rounded-md bg-white shadow-sm">
        <table class="w-full text-sm text-slate-700">
            <thead class="bg-slate-50 text-slate-600 text-xs uppercase">
                <tr>
                    <th class="px-4 py-3 text-left text-xs font-semibold text-slate-600 uppercase">Título</th>
                    <th class="px-4 py-3 text-center text-xs font-semibold text-slate-600 uppercase">Nº</th>
                    <th class="px-4 py-3 text-center text-xs font-semibold text-slate-600 uppercase">Vigente desde</th>
                    <th class="px-4 py-3 text-center text-xs font-semibold text-slate-600 uppercase">Estado</th>
                    <th class="px-4 py-3 text-center text-xs font-semibold text-slate-600 uppercase">Formato</th>
                    <th class="px-4 py-3 text-center text-xs font-semibold text-slate-600 uppercase">Acciones</th>
                </tr>
            </thead>
