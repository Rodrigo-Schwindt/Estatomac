...
<div class=" mx-auto space-y-8 animate-fadeIn">
    <form action="{{ route('categorias.store') }}" method="POST" enctype="multipart/form-data" class="bg-white border border-slate-200 rounded-md shadow-sm p-8 space-y-6">
        @csrf
        
        <div class="space-y-6">
            <div class="flex items-center justify-between">
                <h2 class="text-2xl font-semibold text-slate-900">Crear Categoría</h2>
        ...
        <div class="flex items-center gap-2 mt-4">
            ...
            <input type="checkbox" name="sin_descuentos" id="sin_descuentos" value="1" {{ old('sin_descuentos') ? 'checked' : '' }} class="rounded border-slate-300">
        ...
        <div class="space-y-6">
            ...
            <div id="subcategoriasContainer" class="space-y-4"></div>
        </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div>
                    ...
                    <select name="subcategorias[${index}][tolerancia]" 
                            class="w-full cursor-pointer px-4 py-2 border border-slate-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-600"
                            required>
