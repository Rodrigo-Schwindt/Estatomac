...
<div class="mx-auto space-y-8 animate-fadeIn">
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <h2 class="text-2xl font-semibold text-slate-900">Crear Nueva Familia</h2>
        <a href="{{ route('familias.index') }}" class="inline-flex items-center px-4 py-2 border border-slate-300 text-sm font-medium rounded-md text-slate-700 hover:bg-slate-50 transition duration-150 cursor-pointer">
            ← Volver a la lista
        </a>
    </div>
    ...
    <form id="familiaForm" class="bg-white rounded-md border border-slate-200 p-6 space-y-6 shadow-sm">
        ...
        <div x-data="{ preview: null }">
            ...
            <div class="flex items-start gap-4">
                ...
                <div x-show="preview" class="relative">
                    <img :src="preview" alt="Vista previa" class="w-40 h-28 object-cover rounded-lg border border-slate-200">
        ...
        <div class="flex justify-end gap-3 pt-4 border-t border-slate-200">
            ...
            <button type="submit"
                ...
                <span id="submitText">Crear Familia</span>
        ...
        .then(data => {
            if (data.success) {
                ...
                if (data.errors) {
                    ...
                    showAlert(data.message || 'Error al crear la familia', 'error');
                }
            }
        })
        .catch(error => {
