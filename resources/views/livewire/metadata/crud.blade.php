    ...
    <div class="space-y-10 animate-fadeIn bg-white border border-slate-200 rounded-md shadow-sm p-8">
                        ...
                        <tr class="hover:bg-gray-50">
                            <td class="px-4 py-3">
                                <span class="font-medium text-gray-900">
                                    {{ metadataName($item->section, $products, $categories, $novedades) }}
                                </span>
                            </td>
        ...
        <div id="form" class="hidden">
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                <h2 class="text-xl font-semibold mb-5" id="formTitle">Crear metadato</h2>
