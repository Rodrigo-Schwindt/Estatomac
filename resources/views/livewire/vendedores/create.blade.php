...
<div class="container mx-auto px-4 py-6">
    <div class="mb-6">
        <h1 class="text-2xl font-bold">Crear Nuevo Vendedor</h1>
    </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    >
                        ...
                        @foreach($todosVendedores as $v)
                            <option value="{{ $v->id }}" {{ old('opera_como') == $v->id ? 'selected' : '' }}>
                                {{ $v->nombre }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-2">
                        Contraseña
                        <span class="text-gray-400 font-normal text-xs">(por defecto: todotex2025)</span>
                    </label>
                    <input
                        type="password"
                        name="password"
                ...
                <div class="md:col-span-2">
                    <label class="flex items-center gap-3">
                        ...
                        <div class="relative inline-block">
                            ...
                            <input type="checkbox" name="activo" value="1" id="toggle-activo" checked class="sr-only peer">
