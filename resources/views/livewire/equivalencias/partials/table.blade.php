    ...
    <td class="px-4 py-3">
        <div class="flex items-center justify-center gap-2">
            <a href="{{ route('equivalencias.edit', $equivalencia) }}" 
               class="inline-flex items-center justify-center w-8 h-8  text-blue-600 rounded  transition"
               title="Editar">
            ...
            <button type="button" 
                    class="delete-btn inline-flex cursor-pointer items-center justify-center w-8 h-8  text-red-600 rounded transition"
