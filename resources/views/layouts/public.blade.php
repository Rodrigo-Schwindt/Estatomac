...
<header 
x-data="{ open: false }"
class="items-center bg-transparent absolute top-0 items-center flex z-50 w-full h-[100px]">
...
<div class="max-w-[1224px] mx-auto flex justify-between items-center w-full px-4 lg:px-0">
    ...
    <a wire:navigate href="{{ url('/') }}" class="w-fit h-[58px] flex-shrink-0 cursor-pointer max-lg:w-40">
        <img src="{{ Storage::url($contactData->icono_2) }}" class="w-full h-full object-contain">
    </a>
    @endif
