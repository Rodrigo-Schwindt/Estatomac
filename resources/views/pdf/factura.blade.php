...
<body>
    ...
    <div class="info-box" style="margin-bottom: 20px;">
        ...
        <p><strong>Fecha de entrega:</strong> {{ $pedido->fecha_entrega ? $pedido->fecha_entrega->format('d/m/Y') : '-' }}</p>
        ...
        @foreach($pedido->items as $item)
            ...
            <tr>
                ...
                <td class="text-right">
                    ...
                    @if($descuentoBasePct > 0 || $descuentoPersonalizadoPct > 0)
                    <br><small style="color: #308C05;">
                        @if($descuentoBasePct > 0) Desc. {{ number_format($descuentoBasePct, 0) }}% @endif
                        @if($descuentoPersonalizadoPct > 0) + {{ number_format($descuentoPersonalizadoPct, 0) }}% pers. @endif
                    </small>
                    @endif
                    @endif
                </td>
